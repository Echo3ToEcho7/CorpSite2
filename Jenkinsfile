pipeline {
    parameters {
        booleanParam(defaultValue: false, description: 'Is this a Production Deployment', name: 'productionBuild')
        string(defaultValue: '', description: 'The Commit SHA of the Production Deployment', name: 'commitSHA', trim: true)
    }
    agent any
    tools { 
        maven 'Jenkins Maven' 
